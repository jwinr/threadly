...
export default class AnimatedNavbar extends Component {
  ...
  render() {
    ...
    if (typeof currentIndex === "number") {
      CurrentDropdown = this.state.categories[currentIndex]
    }
    if (typeof prevIndex === "number") {
      PrevDropdown = this.state.categories[prevIndex]
              ...
              >
                {currentIndex === index && (
                  <DropdownContainer
                    ...
                    duration={duration}
                  >
                    <ProductsDropdown category={CurrentDropdown} />
                    {PrevDropdown && (
                      <ProductsDropdown category={PrevDropdown} />
                    )}
                  </DropdownContainer>
                )}
              </NavbarItem>
