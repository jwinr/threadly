  ...
  return (
    <>
      ...
      <PrivacyPageWrapper>
        ...
        <p>
          Threadly provides its services globally and the Threadly entity
          ...
          fall under Threadly (“Threadly”, “we”, “our” or “us”).
        </p>
        <p>
          {" "}
        ...
        <p>
          {" "}
          This policy applies to Threadly’s own Services. Websites, products and
          services of third-parties and some affiliates of Threadly are subject
          to their own separate privacy policies.
        </p>
        ...
        <p>
          ...
          to your Threadly account or by contacting us through the contact
        ...
        <ListWrapper role="list">
          <li>
            The right to request confirmation of whether Threadly processes
            Personal Information relating to you, and if so, to request a copy
            of that Personal Information.
          </li>
          <li>
            The right to request that Threadly rectifies or updates your
            Personal Information that is inaccurate, incomplete or outdated.
          </li>
          <li>
            The right to request that Threadly erase your Personal Information
            in certain circumstances provided by law.
          </li>
          <li>
            The right to request that Threadly restrict the use of your Personal
            Information.
          </li>
          <li>
        ...
        <p>
          You can access your personal information through your Threadly
        ...
        <p>
          ...
          by e‑mail at help@shopThreadly.com
        </p>
      </PrivacyPageWrapper>
    </>
  )
