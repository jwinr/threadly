  ...
  return (
    <>
      <PrivacyPageWrapper role="main">
        ...
        <section>
          <p>
            At Threadly, we take your privacy seriously. Please read this
            Privacy Policy to learn how we treat your personal data. By using or
            accessing our Sites and Services in any manner, you accept the
            practices and policies outlined in this Privacy Notice and you
        ...
        <section>
          ...
          <p>
            ...
            Personal Data. Please remember that no method of transmission over
        ...
        <section>
          ...
          <p>
            We use Stripe for payments, analytics, and other business services.
            Stripe may collect personal data including via cookies and similar
            ...
            the performance of its services. You can learn more about Stripe and
            read its privacy policy at{' '}
            <b>
          ...
          <p>
            We use Amazon Web Services (AWS), including Amazon Cognito, which
            collect personal information to operate, provide, and improve AWS
            offerings. This information includes data you provide directly, data
            collected automatically during interactions, and data from other
            sources. AWS uses this information for various purposes, such as
            processing transactions, personalizing your experience, preventing
            fraud, and complying with legal obligations. You can read more about
            how AWS uses your Personal Information at{' '}
            <b>
          ...
          <p>
            ...
            Service. Google Analytics is a web analytics service offered by
        ...
        <section>
          ...
          <p>
            The Site and Services are not directed or intended for use by
