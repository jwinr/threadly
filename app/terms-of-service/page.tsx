    ...
    <>
      <TermsPageWrapper role="main">
        ...
        <section>
          ...
          <p>
            This website is independently operated by Threadly. Throughout the site, the terms “we,”
            “us,” and “our” refer to Threadly and/or its owner. This site is for demonstration
            purposes only and does not facilitate any real transactions or sales. It is not
            affiliated with, endorsed by, or connected to any recognized brands or companies. All
            trademarks and images are the property of their respective owners.
          </p>
          <p>
            By using this site, you agree to be bound by these Terms of Service. If you do not
            agree, you may not use the site.
          </p>
          <p>
            We may update or modify these Terms of Service from time to time. Any new features or
            changes to the site will be subject to the most current version of the Terms of Service.
            We encourage you to review this page periodically. Continued use of the site following
            any updates constitutes your acceptance of the new terms.
          </p>
        </section>
        <section>
        ...
        <section>
          <SubheaderText>3. Accuracy, Completeness and Timeliness of Information.</SubheaderText>
          <p>
            The information on this site is for demonstration purposes only and may not be accurate,
            complete, or current. We reserve the right to modify the content at any time without
            obligation to update it.
          </p>
        </section>
        <section>
          <SubheaderText>4. Modifications to the Service and Pricing.</SubheaderText>
          <p>
        ...
        <section>
          ...
          <p>
            We may include descriptions or depictions of products or services for demonstrative
            purposes only. These products or services are not offered for sale, and no transactions
            or purchases can be made through the Service. While efforts are made to ensure the
            accuracy of the information provided, we do not guarantee the completeness or
            reliability of any products or services mentioned. All intellectual property rights
            associated with the products or services belong to their respective owners. The
            information provided should not be construed as professional advice, and we reserve the
            right to modify or remove any products or services at any time without notice.
          </p>
          <p>
        ...
        <section>
          <SubheaderText>6. Accuracy of Billing and Account Information.</SubheaderText>
          <p>
            While our Service may include features that allow users to interact with payment
            processing services such as Stripe or PayPal, please note that these features are for
            demonstration purposes only. No actual transactions or payments can be processed through
            the Service.
          </p>
          <p>
            By using any payment processing features on this site, including the provision of demo
            card information, you acknowledge that any payment information you provide is solely for
            demonstration purposes and is used in Stripe’s test mode. These demo transactions are
            for illustrative purposes only and do not involve real transactions or require accurate
            billing details.
          </p>
          <p>
            You are responsible for maintaining the confidentiality of any account information
            provided and for any activity that occurs under your account. We reserve the right to
            modify or remove any payment processing features at any time without notice.
          </p>
        </section>
        <section>
          <SubheaderText>7. Third-Party Links.</SubheaderText>
          <p>
            This site may include links to third-party websites or materials. We are not responsible
            for the content, accuracy, or any issues arising from the use of third-party websites or
            products.
          </p>
          <p>
            Any interactions with third-party sites are at your own risk. Please review their
            policies before engaging with them, as we are not liable for any related damages or
            issues.
          </p>
        </section>
        <section>
          ...
          <p>
            We value your feedback and are eager to hear your thoughts. Your input helps us enhance
            the site, and we appreciate the time you take to share it with us. While we may not be
            able to act on every suggestion, please know that all feedback is carefully considered.
          </p>
          <p>
            We may monitor, edit, or remove any product reviews that are unlawful, offensive, or
            violate rights. We assume no liability for reviews or comments posted by users.
          </p>
        </section>
        <section>
          <SubheaderText>9. Personal Information.</SubheaderText>
          <p>
            We may collect certain data from users to enhance the demo experience or analyze site
            usage. All data is collected and processed in accordance with our{' '}
            <Link href={`/privacy-policy`}>Privacy Policy</Link>, which outlines how we handle your
        ...
        <section>
          ...
          <p>
            The information on this site may contain errors, inaccuracies, or omissions. We reserve
            the right to correct any such issues and update the content at any time without prior
            notice.
          </p>
          <p>
            This site is for demonstration purposes only, and any information provided should not be
            relied upon for real transactions.
          </p>
        </section>
        <section>
          <SubheaderText>11. Prohibited Uses.</SubheaderText>
          <p>
            You are prohibited from using this site or its content for any unlawful purpose, to
            violate any laws, to infringe on intellectual property rights, to harass or discriminate
            against others, to submit false information, or to introduce harmful code. Additionally,
            you may not interfere with the site's security features or use the site to collect
            personal information without consent.
          </p>
          <p>
            We reserve the right to terminate your use of the site for violating these prohibitions.
          </p>
        </section>
        <section>
          <SubheaderText>12. Disclaimer of Warranties; Limitation of Liability.</SubheaderText>
          <p>
            This site is provided "as is" and "as available," without any warranties of any kind. We
            do not guarantee that your use of the site will be uninterrupted, secure, or error-free,
            and we make no warranties about the accuracy or reliability of the results.
          </p>
          <p>
            You use this site at your own risk. We are not liable for any damages, including lost
            profits, data loss, or other losses resulting from your use of the site.
          </p>
        ...
        <section>
          ...
          <p>
            You agree to indemnify and hold harmless Threadly and its owner from any claims,
            damages, or expenses, including reasonable attorneys' fees, arising from your breach of
