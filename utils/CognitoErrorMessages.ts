...
const CognitoErrorMessages = {
  ...
  UserNotFoundException: 'User does not exist. Please check your email address.',
  ...
  InvalidParameterException: "This email hasn't been verified. Please contact support.",
